  ...
  return (
    <div className="space-y-6 animate-fade-in" id="gabriel_vintage_grid">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        {/* =======================================================
            DESKTOP-FIRST SIDEBAR CATEGORIES (Clean Elegant layout)
            ======================================================= */}
        ...
        <div className="col-span-1 lg:col-span-3 space-y-6">
          ...
          {/* 1. Large Gabriel Promo Banner Carousel */}
          ...
          {/* =======================================================
              ...
              Makes it incredibly easy to understand & shop the platform
              ======================================================= */}
          ...
          {/* Quick Department Filter (Phone scroller) */}
          ...
          {/* 2. Gabriel Premium Sourced banner */}
                      ...
                      <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
                        <div className="space-y-1">
                          ...
                          <div className="flex items-center gap-1 pt-1">
                            ...
                            <span className="text-[10px] text-stone-400 font-mono">(96% positive)</span>
                          </div>
                        </div>
